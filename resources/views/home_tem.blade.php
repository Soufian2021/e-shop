                            ...
                            <div class="limit-box">
                                <nav class="main-menu">
                                    <ul class="menu-area-main">
                                        ...
                                        <li class="nav-item">
                                            <a href="#" class="ml-4 text-sm text-gray-700 underline"><i
                                                    class="fas fa-plus"></i>
                                                Register</a>
                                        </li>
                                        @endif
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 thumb">
                    <div class="service-box">
                        <figure>
                            ...
                            <span class="hoverle">
                                <a href="{{url('/anti-covid')}}" class="fancybox" rel="ligthbox" id="category"
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 thumb">
                    <div class="service-box">
                        <figure>
                            ...
                            <span class="hoverle">
                                <a href="{{url('/medecines')}}" class="fancybox" rel="ligthbox"
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 thumb">
                    <div class="service-box">
                        <figure>
                            ...
                            <span class="hoverle">
                                <a href="{{url('/selfcare')}}" class="fancybox" rel="ligthbox"
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 thumb">
                    <div class="service-box">
                        <figure>
                            ...
                            <span class="hoverle">
                                <a href="{{url('/health')}}" class="fancybox" rel="ligthbox"
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 thumb">
                    <div class="service-box">
                        <figure>
                            ...
                            <span class="hoverle">
                                <a href="{{url('/mombaby')}}" class="fancybox" rel="ligthbox"
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 thumb">
                    <div class="service-box">
                        <figure>
                            ...
                            <span class="hoverle">
                                <a href="{{url('/vitamins')}}" class="fancybox" rel="ligthbox"
